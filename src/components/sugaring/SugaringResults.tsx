...
const stats = [
  { value: '3–4 нед.', label: 'гладкость после одной процедуры' },
  { value: '3–5 мм', label: 'оптимальная длина волос для процедуры' },
  { value: 'сразу', label: 'результат виден в день процедуры' },
  { value: 'мягче', label: 'волосы отрастают тоньше и мягче' },
]

export default function SugaringResults() {
  return (
    <section id="results" className="py-20 px-5 md:px-12 bg-mist/20">
      <div className="max-w-4xl mx-auto">
        <SectionHeader sub="Чего ожидать" title="Результат шугаринга" description="Реальные ожидания — без преувеличений." />
