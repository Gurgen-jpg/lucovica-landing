...
import { electroEpilFaqs } from './ElectroEpilFAQ.data'

export default function ElectroEpilFAQ() {
  const [open, setOpen] = useState<number | null>(null)

  return (
    <section id="faq" className="py-20 px-5 md:px-12 bg-white">
      <div className="max-w-3xl mx-auto">
        <SectionHeader sub="Вопросы и ответы" title="Часто спрашивают об электроэпиляции" />

        <div className="space-y-3">
          {electroEpilFaqs.map((faq, i) => (
